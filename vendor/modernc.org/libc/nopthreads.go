...
//go:build windows || darwin || (linux && arm) || (linux && s390x) || (linux && arm) || (linux && arm64) || (freebsd && amd64) || (netbsd && amd64)
// +build windows darwin linux,arm linux,s390x linux,arm linux,arm64 freebsd,amd64 netbsd,amd64
